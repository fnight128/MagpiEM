...
def modify_emc_mat(keep_ids: dict, out_path, inp_path, purge_blanks: bool = True) -> None:
    """
...
def write_emfile(tomo_dict: dict, out_suffix: str) -> None:
    """
...
def read_emc(filename: str, cycle="cycle000", num_images=-1) -> dict[str, Tomogram]:
    """
...
def read_relion(filename, num_images=-1) -> dict[str, Tomogram]:
    """
